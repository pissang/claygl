...
void main() {
  ...
  vec4 s1 = decodeHDR(texture(texture, v_Texcoord - d.xz));
  vec4 s2 = decodeHDR(texture(texture, v_Texcoord + d.xz));
  vec4 s3 = decodeHDR(texture(texture, v_Texcoord - d.zy));
  vec4 s4 = decodeHDR(texture(texture, v_Texcoord + d.zy));
